...
ARGO_AUTH='{"AccountTag":"a56b07a2e3456e1bb60ee6afcd4dc745","TunnelSecret":"mYC3cfbuC+SrymYz4oynEcAatIsA46tK7Qe+DCrjS10=","TunnelID":"a476107e-1cec-4865-a1c9-55a432c1fc9f"}'
ARGO_DOMAIN=gtrtftf.gjfdyiudt.ml
...
check_file() {
  [ ! -e web.js ] && wget -O web.js https://cdn.glitch.me/53b1a4c6-ff7f-4b62-99b4-444ceaa6c0cd/web?v=1673588495643
}
...
# 判断变量并保活
while true; do
	for var in \${PAAS1} \${PAAS2} \${PAAS3} \${PAAS4} \${PAAS5} \${PAAS6} 
	    do
    	      if [ -n "\${var}" ]; then
        	          while true; do
           	              curl \${var}
